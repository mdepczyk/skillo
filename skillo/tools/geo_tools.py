...
def calculate_distance_tool(cities: str) -> str:
    ...
    Args:
        cities: Two cities separated by ' | ', e.g. "Warsaw, Poland | Berlin, Germany"

    Returns:
        String with distance information or error message
    """
    try:
        if " | " not in cities:
        ...
        geolocator = Nominatim(user_agent="skillo")
