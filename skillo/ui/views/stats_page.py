...
def render(app_facade: ApplicationFacade) -> None:
    ...
    try:
        ...
        config_values = app_facade.get_config_values()
...
def _render_document_counts(stats: dict) -> None:
...
def _render_document_distribution(stats: dict) -> None:
...
def _render_database_health(stats: dict, config_values: dict) -> None:
...
def _render_configuration_info(config_values: dict) -> None:
