...
from skillo.domain.enums import ExperienceLevel
from skillo.infrastructure.config.settings import Config
from skillo.infrastructure.logger import logger
from skillo.infrastructure.schemas import ExperienceAnalysisResponse
...
def create_experience_agent(config: Config) -> LangChainExperienceAgent:
    return LangChainExperienceAgent(config)
