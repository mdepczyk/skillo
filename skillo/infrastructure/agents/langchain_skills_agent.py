...
from skillo.infrastructure.schemas import SkillsAnalysisResponse
...
class LangChainSkillsAgent:
    ...
    def __init__(self, config: Config) -> None:
        ...
        ).with_structured_output(SkillsAnalysisResponse)
    ...
    def analyze_skills_match(
        ...
        try:
            ...
            response: SkillsAnalysisResponse = self.llm.invoke(
                formatted_prompt
            )
...
def create_skills_agent(config: Config) -> LangChainSkillsAgent:
    return LangChainSkillsAgent(config)
