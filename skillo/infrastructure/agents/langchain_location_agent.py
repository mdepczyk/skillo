...
from skillo.domain.enums import CommuteFeasibility, RemoteWorkStatus
from skillo.infrastructure.config.settings import Config
from skillo.infrastructure.logger import logger
from skillo.infrastructure.schemas import LocationAnalysisResponse
...
def create_location_agent(config: Config) -> LangChainLocationAgent:
    return LangChainLocationAgent(config)
