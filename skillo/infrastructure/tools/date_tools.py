...
def calculate_years_between_tool(
    ...
    Args:
        start_date: Start date in format "YYYY-MM-DD" or "MM.YYYY" or "YYYY"
        end_date: End date in same format, or "current" for current date

    Returns:
        String with years calculation or error message
    """
    try:
